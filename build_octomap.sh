...
BUILD_DIR="${BUILD_DIR:-${ROOT_DIR}/build_humble}"
...
echo "Configuring and building ORB_SLAM2 OctoMap variant ..."
set +u
...
"${CMAKE_BIN}" --build "${BUILD_DIR}" -j"${JOBS}" --target ORB_SLAM2 rgbd_tum_octomap

echo
echo "Build completed in ${BUILD_DIR}"
echo "  - ${ROOT_DIR}/Examples/RGB-D/rgbd_tum_octomap"
